...
const resultsMedia = [
    ...
    //     name: 'Dezignful',
    //     introText: 'Sample intro text for Dezignful.',
    //     media: [
        ...
        <section id='results' className='container app__results'>
            ...
            <div className="app__results-container">
                <div className="app__results-selector">
                    ...
                    <div key={result.name} className={`app__results-selector-item ${selectedResult === result && 'selectedItem'}`} onClick={() => handleResultClick(result)}>
